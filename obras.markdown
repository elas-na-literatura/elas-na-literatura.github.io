  ...
  for(val in obrasDeVerdade)
  {
    ...
    switch(obrasDeVerdade[i].escola)
    {
      case "prosa":
        ...
        '<a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-text="Olha essa obra maravilhosa da ' + obrasDeVerdade[i].autora + ' que eu encontrei! " data-url="https://elas-na-literatura.github.io/obras/' + obrasDeVerdade[i].link + '" data-hashtags="ElasNaLiteratura" data-lang="pt" data-show-count="false"><img src="https://elas-na-literatura.github.io/rsc/twitter.svg" alt="Twitter" style="margin-top:-11px;margin-right:5px;"></a>'+'<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>' +
